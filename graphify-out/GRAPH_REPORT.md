...
## Corpus Check
- 198 files · ~55,735 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2317 nodes · 3538 edges · 129 communities (124 shown, 5 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 28 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `d2717fe5`
...
Cohesion: 0.02
Nodes (98): ../../daily/screens/person_daily_section.dart, Iterable, actionErrorMessage, _availableWidth, canGenerateAccessToken, canManageGrowth, canShowOneOnOne, child (+90 more)
...
Cohesion: 0.06
Nodes (38): ../../../core/widgets/inputs/app_date_field.dart, ../../../core/widgets/inputs/app_dropdown_field.dart, _admissionDate, _admissionDateError, _birthDate, _birthDateError, build, _contractType (+30 more)
...
Cohesion: 0.06
Nodes (36): _InlinePagination, _IntegrationTabBar, _MetricTile, _Surface, _SystemTile, _TokenPanel, _ActionErrorBanner, _AnalysisTab (+28 more)

### Community 14 - "person.dart"
Cohesion: 0.06
Nodes (32): contract_type.dart, apiValue, ContractType, fromApiValue, label, admissionDate, age, averageActualSeconds (+24 more)
...
### Community 24 - "Mock"
Cohesion: 0.13
Nodes (27): DailyMeetingRepository, PersonRepository, TeamRepository, Mock, _MockDailyMeetingRepository, _MockPersonRepository, _MockTeamRepository, _MockDailyMeetingRepository (+19 more)
...
Cohesion: 0.11
Nodes (18): accept_invitation_form.dart, app.dart, bootstrap.dart, ../../../core/theme/app_spacing.dart, AcceptInvitationScreen, build, build, LoginScreen (+10 more)
...
Cohesion: 0.13
Nodes (19): ../../../core/widgets/buttons/app_dialog_actions.dart, ../../../core/widgets/states/loading_view.dart, BaseViewModel, PersonDailyStatsViewModel, NotificationsViewModel, PeopleListViewModel, build, TeamDetailScreen (+11 more)
...
### Community 39 - "person_detail_screen.dart"
Cohesion: 0.13
Nodes (16): ../../../core/widgets/navigation/app_page_header.dart, ../../../core/widgets/states/error_view.dart, daily_history_body.dart, home_body.dart, teamId, build, HomeScreen, HomeViewModel (+8 more)
...
Cohesion: 0.14
Nodes (17): AppDataTable, _AppDataTableState, build, createState, dispose, _emailController, _nameController, _passwordConfirmationController (+9 more)

### Community 46 - "person_service.dart"
Cohesion: 0.12
Nodes (16): _client, createInvitation, _dateFormat, index, show, showMe, store, update (+8 more)
...
### Community 49 - "daily_config_body_test.dart"
Cohesion: 0.12
...
### Community 50 - "team_members_section.dart"
Cohesion: 0.14
Nodes (14): ../../../core/routing/route_paths.dart, ../../../core/widgets/tables/app_data_table.dart, TeamDetailBody, build, _InlinePagination, lastPage, loading, onNext (+6 more)
...
### Community 56 - "daily_meeting_detail_screen.dart"
Cohesion: 0.16
Nodes (13): daily_meeting_detail_body.dart, DailyMeeting? get, DailyMeeting, build, DailyMeetingDetailScreen, meetingId, DailyMeetingDetailViewModel, load (+5 more)
...
Cohesion: 0.13
Nodes (14): package:for_tech_lead/core/theme/app_spacing.dart, package:for_tech_lead/features/daily/screens/daily_running_body.dart, package:for_tech_lead/features/daily/screens/daily_timer_ring.dart, return, loadParticipants, main, meetingRepository, Mock (+6 more)
...
### Community 67 - "home_view_model.dart"
Cohesion: 0.14
...
Cohesion: 0.19
Nodes (12): ../../../core/widgets/branding/app_logo.dart, ../../../core/widgets/buttons/app_primary_button.dart, build, createState, dispose, _emailController, LoginForm, _LoginFormState (+4 more)

### Community 71 - "../../people/models/person.dart"
Cohesion: 0.17
...
### Community 76 - "daily_review_body.dart"
Cohesion: 0.18
Nodes (11): @immutable, AppThemeExtension, blockers, _BlockersReview, build, DailyReviewBody, topics, _TopicsReview (+3 more)

### Community 77 - "app_logo.dart"
Cohesion: 0.17
...
### Community 95 - "app_dialog_actions.dart"
Cohesion: 0.22
...
### Community 96 - "int?"
Cohesion: 0.22
Nodes (8): bool get, int?, actualSeconds, allowedSeconds, DailyTurnDraft, hasSpoken, person, Person
...
### Community 101 - "person_form_view_model.dart"
Cohesion: 0.22
Nodes (8): createPerson, isEditing, load, _person, personId, _repository, savePerson, teamId
...
Cohesion: 0.22
Nodes (8): _client, destroy, index, show, store, TeamService, update, _MockTeamService
...
### Community 115 - "build"
Cohesion: 0.40
Nodes (5): _historyLink, build, build, RoutePaths.dailyHistoryPath, RoutePaths.dailySessionPath
...
## Knowledge Gaps
- **1378 isolated node(s):** `build`, `getIt`, `authSession`, `configureDependencies`, `restore` (+1373 more)
...
- **Why does `PersonRepository` connect `Mock` to `daily_history_view_model.dart`, `daily_session_view_model.dart`, `home_view_model.dart`, `daily_session_screen.dart`, `integrations_screen.dart`, `person_form_view_model.dart`, `person_detail_screen.dart`, `integrations_view_model.dart`, `person_form.dart`, `home_view_model_test.dart`, `person_detail_body_layout_test.dart`, `package:mocktail/mocktail.dart`, `person_repository.dart`, `person_detail_view_model.dart`, `profile_screen.dart`, `people_list_view_model.dart`, `bootstrap.dart`?**
  _High betweenness centrality (0.045) - this node is a cross-community bridge._
- **Why does `DailyMeetingRepository` connect `Mock` to `daily_history_view_model.dart`, `daily_session_view_model.dart`, `daily_session_screen.dart`, `daily_meeting_detail_body.dart`, `person_detail_screen.dart`, `daily_meeting_detail_screen.dart`, `daily_meeting_repository_test.dart`, `bootstrap.dart`?**
  _High betweenness centrality (0.014) - this node is a cross-community bridge._
- **Why does `TeamRepository` connect `Mock` to `daily_session_view_model.dart`, `home_view_model.dart`, `daily_session_screen.dart`, `BaseViewModel`, `team_repository.dart`, `person_detail_screen.dart`, `List`, `team_detail_view_model.dart`, `teams_list_view_model_test.dart`, `bootstrap.dart`?**
